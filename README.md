...
- v0.3.2, 2025-06-08
  - 終了直前にデスクトップを切り替えた場合に切り替え前のデスクトップ名の行を更新していたため、行を追加するように修正した
  - デバッグ用ファイルへ直接出力する処理が残っていたため、デバッグ用出力関数を利用するように修正した
- v0.3.1, 2025-04-28
  - Pro / Enterprise でアンインストールした場合にグループポリシーを手動で設定しなおすよう促す表示を追加した
- v0.3.0, 2025-04-27
