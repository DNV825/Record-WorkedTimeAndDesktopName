...
```text
2025/04/02	2025/04/02 09:00	2025/04/02 12:00		プロジェクト A
2025/04/02	2025/04/02 13:00	2025/04/02 14:00		プロジェクト B
2025/04/02	2025/04/02 14:00	2025/04/02 17:00		プロジェクト A
```

続いて、タブ区切りテキストはエクセルにコピペで貼り付ける。以下のような Excel ファイルを作っておき、作業時間の入力欄に貼り付ける。

![./img/TSVデータをExcelにコピペ.png](./img/TSVデータをExcelにコピペ.png)

最後にオートフィル機能を利用して作業時間の計算セルを延伸させれば、以下のように作業時間を算出することができる。
